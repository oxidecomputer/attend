...
which makes slow tests easy to spot. Tests should never sleep on wall-clock
time; slow tests are almost certainly a bug. See
[architecture](../explanation/architecture.md#time-abstraction) for why.
...
For design patterns, test architecture, and the rationale behind key decisions,
